...
const MOCK_TEMAS: Tema[] = [
    ...
    { id: 2, nombre: 'Contratos Civiles', asignatura: 'Derecho Civil I', pautaAsignada: false },
    { id: 3, nombre: 'Proceso Penal', asignatura: 'Derecho Procesal', pautaAsignada: true, nombrePauta: 'Rúbrica Procesal Oral' },
    { id: 4, nombre: 'Derechos Fundamentales', asignatura: 'Derecho Constitucional', pautaAsignada: false },
];
...
export default function Comisiones() {
    ...
    const handleTemaChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        if (tema?.nombrePauta) {
            setNombrePauta(tema.nombrePauta);
        } else {
            setNombrePauta('');
        }
    };
                        ...
                        <>
                            ...
                            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {/* Input para nombre de pauta */}
                                    <div>
                                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">
                                            Nombre de la Pauta / Guideline
                                        </label>
                                        <input
                                            type="text"
                                            value={nombrePauta}
                                            ...
                                            placeholder="Ej: Pauta de Evaluación Oral - Derecho Civil 2025"
                                        />
                                    </div>

                                    <button className="inline-flex items-center px-4 py-2 bg-[#003366] text-white rounded-lg hover:bg-[#004488] transition text-sm">
